<template>
	<div class="chip-picker medication-picker">
		<div class="picker-header">
			<span class="picker-label">{{ t('nextdiary', 'Medications') }}</span>
		...
		<div v-if="expanded" class="picker-cloud">
			...
			<div class="picker-input-row">
				<input v-model="inputValue"
					type="text"
					class="picker-input"
					:placeholder="t('nextdiary', 'New medication...')"
